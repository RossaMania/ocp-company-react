     ...
     <div>
       <AboutUs
         ...
         content="Omni Consumer Products, or OCP, is the firm which recently agreed
          ...
          it.”"
         id="about"
         onViewDetails={() => handleViewDetails("about")} // Pass the id as a string here
         isExpanded={expanded === "about"} // Compare with the string
       />
       <DeltaCity
         title="Delta City"
         content="Labor leaders agreed to sanction construction of OCP's Delta City
          ...
          enterprise!"
         id="delta"
         onViewDetails={() => handleViewDetails("delta")} // Pass the id as a string here
         isExpanded={expanded === "delta"} // Compare with the string
       />
       <TheFuture
         ...
         id="future"
         onViewDetails={() => handleViewDetails("future")} // Pass the id as a string here
         isExpanded={expanded === "future"} // Compare with the string
       />
       <RoboCopTrailer />
     </div>
   );
